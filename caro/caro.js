...
function Cell(x, y) {
    ...
    this.getHtml = function(){
        ...
        var cellHtml = '<div id="cell-'+x+'-'+y+'" onclick="play('+x+','+y+')" class="cell" style="position: absolute;background-color: moccasin; border: 1px solid blue;text-align: center; width: '+
...
function btStart() {
    if(confirm("Are you sure play again !")){start()
    }
}
function start() {
